...
<body>
  <div class="page bot-stand-by">
    <div class="in-page loud-link-click">
      <div class="action">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 590 140" style="enable-background:new 0 0 590 140;" xml:space="preserve">
        <g>
          <path class="st0" d="M77.7,139.1c35,0,52.8-21.2,60.6-39l-34.8-16c-3.4,10.4-13.8,19.4-25.8,19.4c-19.4,0-32.4-14.8-32.4-33.4
          ...
          <path class="st0" d="M241.9,136.7v-35.2h-50.6V3.3h-40.4v133.4H241.9z"/>
          <path class="st0" d="M298.5,136.7V3.3h-40.4v133.4H298.5z"/>
          <path class="st0" d="M386.3,139.1c35,0,52.8-21.2,60.6-39l-34.8-16c-3.4,10.4-13.8,19.4-25.8,19.4c-19.4,0-32.4-14.8-32.4-33.4
            s13-33.4,32.4-33.4c12,0,22.4,9,25.8,19.4l34.8-16.2c-8-18.4-25.6-38.8-60.6-38.8c-41.8,0-73.4,27.8-73.4,69
            C312.9,111.1,344.5,139.1,386.3,139.1z"/>
          <path class="st0" d="M586.5,136.7l-52.6-71.4l50.4-62h-49.4l-35,50v-50h-40.4v133.4h40.4v-37l7.4-10l30,47H586.5z"/>
        </g>
        </svg>
      </div>
      <div class="bot-bg">
        <i class="bg"></i><i class="bg-small bg-first"></i><i class="bg-small bg-second"></i><i class="bg-small bg-third"></i>
      </div>
      <div class="bot">
        <div class="bot-head">
          <div class="bot-face"><i class="eye eye-left"></i><i class="eye eye-right"></i><div class="mouth"></div></div>
          <svg version="1.1" id="head" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 219 157" style="enable-background:new 0 0 219 157;" xml:space="preserve">
            <g>
              <path class="st0" d="M212.1,60.2l-7.4-1c0.7-14.5-0.1-26.4-3.7-30.4C172.4-2.8,44.2,0.2,17,28.8c-4.1,4.4-5.1,16.3-4.3,30.6
            ...
            <path class="st1" d="M204,27.8C175.4-3.8,43.2-0.8,16,27.8c-4,4.2-5,15.3-4.4,28.9c13.4,33.9,32.6,70,45.2,70c23.8,0,19.6-7,52-7
              c26.1,0,20.2,7,52,7c13.3,0,33.5-39.4,47.1-74.5C208.1,40.5,207.1,31.2,204,27.8z"/>
            <path class="st2" d="M132.5,7C86.6,3.6,33.4,11.5,17,28.8c-4.1,4.4-5.1,16.3-4.3,30.6l-5.8,0.8c0,0-2,14.7,0.1,29.2
              c2.1,15.2,8.3,30.2,8.3,30.2l6.6-0.9c0.2,0.9,0.4,1.7,0.6,2.5C33.2,87.5,63.4,17.9,132.5,7z"/>
            <g>
              <path class="st3" d="M111.4,6.2c38.1,0,75.7,7.2,89.6,22.6c3.6,4,4.4,15.9,3.7,30.4l7.4,1c0,0,2,14.7-0.1,29.2
        ...
        <div class="bot-body">
          <div class="bot-body-active">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 226 175" style="enable-background:new 0 0 226 175;" xml:space="preserve">
            ...
            <g class="st2">
              ...
              <ellipse transform="matrix(0.866 -0.5 0.5 0.866 -55.4706 94.9796)" class="st3" cx="149.5" cy="151" rx="10" ry="5.5"/>
            </g>
          ...
          <div class="bot-body-dont-active">
            <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 226 175" style="enable-background:new 0 0 226 175;" xml:space="preserve">
            <path class="st0" d="M205.3,63.1c-3.8-14.1-10.6-25.6-18-31.7c-0.2-5.9-1.1-10.1-2.8-11.9c-11.3-12.2-133-15-144,0
            ...
            <path class="st1" d="M112.1,140.5c-21.7,0-43.2-3.1-58.1-5.8c2.9,11.3,5.3,19.3,6.5,20.8c4.9,6.5,5.7,15,52,15
              c46.3,0,46.3-8.3,52-15c1.4-1.6,3.9-9.5,6.7-20.8C156,137.4,134,140.5,112.1,140.5z"/>
            <g>
              <g>
                <path class="st1" d="M94.5,88.5h37c2.2,0,4-1.8,4-4s-1.8-4-4-4h-37c-2.2,0-4,1.8-4,4S92.3,88.5,94.5,88.5z M131.5,92.5h-37
            ...
            <path class="st2" d="M205.3,63.1c-3.8-14.1-10.6-25.6-18-31.7c-0.2-5.9-1.1-10.1-2.8-11.9c-11.3-12.2-133-15-144,0
              c-1.7,2.4-2.5,7.2-2.7,13.6c-6.6,6.4-12.7,17.1-16.1,30c-6.1,22.9,9.6,47.1,9.6,47.1s7.2-3.7,14.9-10.5c5.5,27.9,12,52.8,14.2,55.8
              c4.9,6.5,5.7,15,52,15c46.3,0,46.3-8.3,52-15c2.6-3.1,9.3-28.8,14.7-57.1c8.2,7.7,16.4,11.9,16.4,11.9S211.4,86.1,205.3,63.1z"/>
            </svg>
          </div>
        </div>
        <div class="levitas"><i class="levitas-first"></i><i class="levitas-second"></i><i class="levitas-third"></i><i class="levitas-four"></i></div>
        <i class="bot-shadow"></i>
      </div>
    </div>

    <div class="conteiner">
      <div class="search">
          <button id="speakbt">Falar</button>
